...
/**
 * This class provides an empty implementation of {@see Protobuf3Visitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class Protobuf3BaseVisitor extends AbstractParseTreeVisitor implements Protobuf3Visitor
{
	/**
	 * {@inheritdoc}
	 *

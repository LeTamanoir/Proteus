...
class Scalars
{
    ...
    /**
     * Decodes a Scalars message from binary protobuf format
        ...
        while ($i < $l) {
            ...
            switch ($fieldNum) {
                ...
                case 10:
                    ...
                    if ($i + 8 > $l) throw new \Exception('Unexpected EOF');
                    $_value = gmp_strval(gmp_import(pack('C*', ...array_slice($bytes, $i, 8)), GMP_BIG_ENDIAN));
                    $i += 8;
                    $d->fixed64 = $_value;
                    break;
                case 11:
                ...
                case 12:
                    ...
                    if ($i + 8 > $l) throw new \Exception('Unexpected EOF');
                    $_value = unpack('q', pack('C*', ...array_slice($bytes, $i, 8)))[1];
                    $i += 8;
                    $d->sfixed64 = $_value;
                    break;
                case 13:
